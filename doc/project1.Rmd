...
library(topicmodels)
```
In this project, I would use these five packages above.
...
```{r}
randomrow<-sample(1:nrow(newdata),10000)
lessdata <- newdata[,'cleaned_hm'][randomrow]
newfile<-as.list(as.character(lessdata))
newdocs<-Corpus(VectorSource(newfile))
